...
class Assignment
  ...
  def find_allusers(offset, limit)
      ...
      @user = User.all.offset(offset).limit(limit).order(updated_at: :asc)
  ...
  def find_todolist_byname(name)
      ...
      # return a collection of TodoList instances that match the provided 
  ...
  def update_password(id, password_digest)
      ...
      @user = User.find_by(id: id).update(password_digest: password_digest)
  end
  ...
  def update_listname(id, name)
      ...
      # (no return is required)
      @todolist = TodoList.find_by(id: id).update(list_name: name)
  end 
  ...
  def delete_user(id)
      ...
      # (no return is required)
      @user = User.find_by(id: id).delete 
  end 
  ...
  def delete_todolist(id)
      ...
      # (no return is required)
      @todolist = TodoList.find_by(id: id).delete
  end
end
